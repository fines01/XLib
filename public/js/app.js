...
(function ($) {
  $(document).ready(function () {
    ...
    $(".nav-toggle").on("click", function () {
      $(".links").each(function () {
        // ev. nicht notwendig, da impizite iteration in jQuery--> TEST???
    ...
    window.myToastr = function (typ, msg) {
      ...
      switch (typ) {
        ...
        case 'info':
          toastr.info(msg, title || 'Success');
          break;

        case 'warning':
          toastr.warning(msg, title || 'Success');
          break;

        case 'error':
          toastr.error(msg, title || 'Success');
          break;
      }
    }; // *** DELETE- MODAL (test) ***
