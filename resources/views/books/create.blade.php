                ...
                <form class="form sm:space-y-8 space-y-6" method="POST" action="{{ route('books.store') }}">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input type="checkbox" id="in-person" name="delivery" class="form-checkbox" value="in-person"
                            {{-- @if (is_array(old('delivery')) && in_array('in-person', old('delivery'))) checked @endif> --}} @if (old('delivery') == 'in-person') checked @endif>
                        ...
                        <input type="checkbox" id="postal" name="delivery" class="form-checkbox" value="postal"
                            {{-- @if (is_array(old('delivery')) && in_array('postal', old('delivery'))) checked @endif> --}} @if (old('delivery') == 'postal') checked ) @endif>
                    ...
                    <input type="hidden" id="title-img" name="titleImg" value="{{ old('title-img') }}">
