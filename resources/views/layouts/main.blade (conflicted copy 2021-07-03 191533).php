...
<body>
    ...
    {{-- MODAL --}}
    <div class="hidden flex bg-indigo-100 bg-opacity-40 inset-0 justify-center items-center fixed top-0 left-0 "
        id="overlay">
        <div class="bg-gray-300 max-w-sm py-4 px-5 rounded shadow-2xl text-gray-800">
            <div class="flex justify-between items-center">
                <h4 class="text-lg font-bold" id="deleteModalLabel" data-title="New Title from data- Attribute!">
                    {{ __('Confirm delete') }}?
                </h4>
            ...
            <div class="mt-2 text-sm">
                <p id="deleteModalBody" data-body="NEW body text from HTML data-* Attribute">
                    {{ __('Are you sure') }}?
                </p>
            </div>
